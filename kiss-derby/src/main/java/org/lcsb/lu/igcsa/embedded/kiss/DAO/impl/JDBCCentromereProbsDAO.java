...
public class JDBCCentromereProbsDAO extends DataLoadDAO
  {
  static Logger log = Logger.getLogger(JDBCCentromereProbsDAO.class.getName());
  ...
  public void insertData(String file) throws IOException
    ...
    String sql = "INSERT INTO " + tableName + "(chr, band, prob) VALUES (?,?,?)";
    String line;
    while ((line = reader.readLine()) != null)
      ...
      jdbcTemplate.update(sql, new Object[]{db[0], db[1], Double.valueOf(db[db.length-1])});
      }
    }
  }
