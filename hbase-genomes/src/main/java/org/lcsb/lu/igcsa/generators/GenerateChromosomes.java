...
//    options.addOption(new Option("n", "parent", true, "parent genome name"));
//    options.addOption(new Option("b", "bands", true, "comma separated band list"));
//    options.addOption(new Option("a", "all", false, "Include all locations before and after the provided bands. Default is false."));
//
//    CommandLine cl = parseOptions(args,  GenerateChromosomes.class);
//    if (!cl.hasOption("o") || !cl.hasOption("n") || !cl.hasOption("b"))
//      {
//      HelpFormatter help = new HelpFormatter();
//      help.printHelp( cl.getArgs() + " found.  Missing one or more options: ", options);
//      System.exit(-1);
//      }
