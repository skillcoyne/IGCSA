...
//    options.addOption(new Option("f", "file", true, "Karyotype file"));
//    options.addOption(new Option("c", "cell-line", true, "cell line name"));
//    options.addOption(new Option("o", "output", true, "output directory"));
//    options.addOption(new Option("b", "bands", true, "generate specific bands"));
//
//    CommandLine cl = parseOptions(args,  SpecialGenerator.class);
//    if (!cl.hasOption("o") || !cl.hasOption("c"))
//      {
//      HelpFormatter help = new HelpFormatter();
//      help.printHelp("Missing output directory or cell line name.", options);
//      System.exit(-1);
//      }
//    else if (!cl.hasOption("b") && !cl.hasOption("f") || (cl.hasOption("b") && cl.hasOption("f")))
//      {
//      HelpFormatter help = new HelpFormatter();
//      help.printHelp("Missing bands or karyotype file or attempted to use both.", options);
//      System.exit(-1);
//      }
//
//
