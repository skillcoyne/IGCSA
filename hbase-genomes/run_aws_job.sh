...
--hbase --hbase-schedule-backup --consistent --backup-dir s3n://insilico/hbase --full-backup-time-interval 2 --full-backup-time-unit minutes \
--jar s3://insilico/HBase-Genomes-1.1.jar --main-class org.lcsb.lu.igcsa.LoadFromFASTA --arg GRCh37 --arg s3n://insilico/FASTA --step-action TERMINATE_JOB_FLOW \
